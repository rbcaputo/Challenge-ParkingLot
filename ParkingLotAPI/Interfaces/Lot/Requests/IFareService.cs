...
namespace ParkingLotAPI.Interfaces.Lot.Requests
{
    public interface IFareService
	{
		...
		public Task<bool> AddFareAsync(FarePostDto fareDto, CancellationToken cancellation);
		public Task<bool?> UpdateCurrentFareAsync(FarePutDto fareDto, CancellationToken cancellation);
